            ...
            <div class="container-fluid">    
                ...
                <div  id="divtop">
                        ...
                        <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br>
                            <div id="dmain"  > 
                               <center><img src="./images/loginuser.png" width="120px" height="120px" ></center>
                                <br>
                                    ...
                                    <input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary" style="width:100px; margin-left: 160px;"><br><br>
                                    <a href="signup.php" style="margin-left: 180px;">Sign Up </a><br><br>
                             </div><br><br>
                     </div>
                    </div>
               </div>
