        ...
        <form id="adform" action="admsnform.php" method="post">
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                    <td> <font style="font-family: Verdana;">Student's Contact</font></td>
                    <td> <input type="number" id="uphn1" name="uphn1" placeholder="254 _" required="true" VT="PH"> </td>
                    <td><font style="font-family: Verdana;">Email Address</font></td>
                    <td> <input type="text" id="uphn2" name="uphn2" placeholder="Email Address" required="true" VT="PH"> </td>
                  </tr>
                ...
                <tr>
                    <td> <font style="font-family: Verdana;"><hr></font>
                    <td> <font style="font-family: Verdana;"><hr></font>
                    <td> <font style="font-family: Verdana;"><hr></font>
                    <td> <font style="font-family: Verdana;"><hr></font>
                ...
                <tr>
                    <td><font style="font-family: Verdana;"> Total Annual Income </font>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="cadr" name="cadr" class="ad" placeholder="Street" required="true"><br>
                          <input type="text" id="cast" name="cast" class="ad" placeholder="City/Town" style="margin-top: 4px;" required="true"><br>
                          <input type="text" id="capin" name="capin" class="ad" placeholder="County" style="margin-top: 4px;"><br>
                          <input type="text" id="camob" name="camob" class="ad" placeholder="Postal Address" style="margin-top: 4px;" required="true"><br>
                </td>
               ...
               <tr>
                    <td><font style="font-family: Verdana;">Course Selection</font></td>
